 ...
 *
 */
/* Injected by the IDF component manager upstream (idf_component.yml: 2.0.2).
 * Vendored into lib/ here, so declare them - the driver logs them at init,
 * which is how a device log can prove WHICH driver is running. */
